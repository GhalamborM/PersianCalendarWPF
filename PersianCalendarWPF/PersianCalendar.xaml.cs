...
/****************************** ghost1372.github.io ******************************\
*	Module Name:	PersianCalendar.xaml.cs
...
namespace PersianCalendarWPF
{
    ...
    public partial class PersianCalendar : UserControl
    {
        ...
        private static string[] daysOfWeek = new string[] { "ش", "ی", "د", "س", "چ", "پ", "ج" };
        ...
        private Button[,] yearModeButtons = new Button[4, 3];
        ...
        private Button[] DecadeModeButtons = new Button[12];
        ...
        private void setMonthModeButtonAppearance(Button button)
        {
