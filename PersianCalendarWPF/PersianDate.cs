...
/****************************** ghost1372.github.io ******************************\
*	Module Name:	PersianDate.cs
*	Project:		PersianCalendarWPF
*	Copyright (C) 2017 Mahdi Hosseini, All rights reserved.
*	This software may be modified and distributed under the terms of the MIT license.  See LICENSE file for details.
*
*	Written by Mahdi Hosseini <Mahdidvb72@gmail.com>,  2018, 3, 28, 02:11 ب.ظ
*	
***********************************************************************************/
using System;
...
namespace PersianCalendarWPF
{
    ...
    {
        private const int period33y = 365 * 33 + 8;

        private const int p33p1 = 366;
        private const int p33p2 = 365 * 20 + 4;
        private const int p33p3 = 366;
        private const int p33p4 = 365 * 11 + 2;

        private const int offset = 365 * 22 + 7;
        private const int offsety = 22;
        private const int period4y = 365 * 4 + 1;
        ...
        private static void monthAndDay(int x, out int m, out int d)
        {
        ...
        private static int yearInP4y(int x)
        {
        ...
        private const int maxYear = 11759224, maxMonth = 6, maxDay = 25;

        public static readonly PersianDate MaxValue = new PersianDate(maxYear, maxMonth, maxDay);

        //min date: "1/1/1"
        private const int minYear = 1, minMonth = 1, minDay = 1;

        public static readonly PersianDate MinValue = new PersianDate(minYear, minMonth, minDay);

        //3/21/0622 12:00:00 AM
        private static DateTime firstDateDateTime = new DateTime(622, 3, 21);

        /// <summary>
        /// compares 2 dates with no validation
        /// </summary>
        private static int comp(int y1, int m1, int d1, int y2, int m2, int d2)
        {
        ...
        private static void yearAndDaysInYear(uint x, out int y, out int ds)
        {
            int a = (int)(x / period33y);
            y = a * 33;
            a = (int)(x % period33y);
        ...
        private static int daysInYear(int m, int d)
        {
        ...
        private uint n;//the only field, stores the number of days passed 1/1/1
        ...
        #endregion IComparable<PersianDate> Members
    }
}